...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        temperatura_c_float= float(temperatura_c_txt)
        temperatura_en_c=(temperatura_c_float * 9/5) + 32
        mensaje= "El resultado en Fahrenheit es {0}".format(temperatura_en_c)
        alert(title="Fahrenheit", message=mensaje)

        

    def btn_convertir_f_c_on_click(self):
        temperatura_f_txt= self.txt_temperatura_f.get()
        temperatura_f_float= float(temperatura_f_txt)
        temperatura_en_f=  (temperatura_f_float - 32) + 5/9  
        mensaje= "El resultado en Centígrados es {0}".format(temperatura_en_f)
        alert(title="Centígrados", message=mensaje)
