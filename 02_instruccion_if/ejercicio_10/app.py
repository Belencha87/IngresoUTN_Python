...
#solucionado
    ...
    def btn_mostrar_on_click(self):
        ...
        if (numero_aleatorio >5):
            alert (title="promocion directa", message= "Promoción directa, la nota es {0}".format(numero_aleatorio))
        elif (numero_aleatorio == 4 and 5 ):
            alert (title= "aprobado", message= "Aprobado, la nota es {0}.".format(numero_aleatorio))
        elif (numero_aleatorio <4):
            alert (title= "desaprobado", message= " Desaprobado, la nota es {0}".format(numero_aleatorio))
