...
#funciona 
    def btn_mostrar_on_click(self):
        ...
        aumento = (sueldo_numero * incremento_numero) / 100 # este es el porcentaje que se calcula: sueldo * porcentaje / 100
        sueldo_con_aumento= sueldo_numero + aumento
        
        mensaje = "El nuevo sueldo es {0} pesos".format(sueldo_con_aumento)
