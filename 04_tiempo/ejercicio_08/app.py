...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        self.ts_inicio_tiempo = time.time()
        
    
    def btn_oculto_on_click(self):
        ts_fin_tiempo = time.time()
        tiempo_total = ts_fin_tiempo - self.ts_inicio_tiempo
        alert(title="", message='Trascurrieron{0} segundos desdes que toco el botón oculto'.format(tiempo_total))
